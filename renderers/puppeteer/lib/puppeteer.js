...
export default class Puppeteer extends Renderer {
  ...
  async browserInit() {
    ...
    this.browser.on("disconnected", () => {
      ...
      this.browser = false
	  //Bot.pickGroup(523260414).sendMsg('Yunzai：Chromium实例关闭或崩溃');
	  common.relpyPrivate('1286865098', 'Yunzai：Chromium实例关闭或崩溃')
    })
  ...
  async screenshot(name, data = {}) {
    ...
    try {
	  ...
	  if (data.sleep) await common.sleep(data.sleep)
